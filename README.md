...
- User Login Credentials: (hulaschandra/hulaschandra)
...
insert into users values('hulaschandra','hulaschandra','hulaschandra','Raj','Bihar','1236547089','hulashchandra@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/hulaschandrarajraja/onlinebookstore.git```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "hulaschandra" And "hulaschandra"
